...
(deftest ^{:doc "Catalog should define at least 6 jurisdictions with official spec-basis."} catalog-has-jurisdictions
...
(deftest ^{:doc "UK (GBR) has a restricted-substances citation distinct in kind from
  ...
  Entry 43, azo dyes)."} uk-restricted-substances
...
(deftest ^{:doc "Germany (DEU) has plant-registration (GewO Section 14 trade-notification
  ...
  official law repository."} germany-requirements
...
(deftest ^{:doc "India jurisdiction should have official spec-basis for all requirements."} india-requirements
