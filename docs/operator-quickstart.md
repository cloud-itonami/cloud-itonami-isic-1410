# Operator Quickstart — Community Apparel Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 1410** (`cloud-itonami-isic-1410`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1410.git
cd cloud-itonami-isic-1410
```
...
- Blueprint governor key: `apparel-governor`
- Likely source path: `apparel.governor.cljc`
